...
class FixInsertDetailPage extends StatefulWidget {
  ...
  ///由前頁傳入來自function
  final fromFunc;
  FixInsertDetailPage({this.custCode, this.userId, this.deptId, this.caseId, this.statusName, this.fromFunc});
  @override
  ...
  Widget detailReportDialog(BuildContext context) {
    return Material(
      ...
      child: Container(
        ...
        child: DetailReportDialog(deptName: userInfo.userData.DeptName, takeName: userInfo.userData.UserName, userId: userInfo.userData.UserID, caseId: widget.caseId, statusName: model.statusName, caseTypeName: model.caseTypeName, fromFunc: 'FixInsert', userInfo: userInfo, deptId: widget.deptId,)
      )
    );
  }
  ///訊號dialog
