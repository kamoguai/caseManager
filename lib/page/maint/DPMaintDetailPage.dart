  ...
  Widget detailReportDialog(BuildContext context) {
    return Material(
      ...
      child: Container(
        ...
        child: DetailReportDialog(deptName: userInfo.userData.DeptName, takeName: userInfo.userData.UserName, userId: userInfo.userData.UserID, caseId: widget.caseId, statusName: model.statusName, fromFunc: 'DPMaint', userInfo: userInfo,)
      )
    );
  }
  ///訊號dialog
