  ...
  Widget detailReportDialog(BuildContext context) {
    return Material(
      ...
      child: Container(
        ...
        child: DetailReportDialog(deptName: userInfo.userData.DeptName, takeName: userInfo.userData.UserName, userId: userInfo.userData.UserID, caseId: widget.caseId, statusName: model.statusName, caseTypeName: model.caseTypeName, fromFunc: 'Maint', userInfo: userInfo, accName: widget.accName, deptId: widget.deptId,)
      )
    );
  }
  ///訊號dialog
