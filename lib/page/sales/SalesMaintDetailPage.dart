...
///裝機問題通知詳情頁面
///Date: 2019-07-01
class SalesMaintDetailPage extends StatefulWidget {
  ///由前頁傳入客編
  final custCode;
  ///由前頁傳入使用者id
  final userId;
  ...
  ///由前頁傳入來自function
  final fromFunc;
  SalesMaintDetailPage({this.custCode, this.userId, this.deptId, this.caseId, this.statusName, this.fromFunc});
  @override
  _SalesMaintDetailPageState createState() => _SalesMaintDetailPageState();
}

class _SalesMaintDetailPageState extends State<SalesMaintDetailPage> with BaseWidget{
