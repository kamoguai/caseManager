...
class MyPullLoadWidget extends StatefulWidget {
  ...
  MyPullLoadWidget(this.control, this.itemBuilder, this.onRefresh, this.onLoadMore, {this.refreshKey});
    ...
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          Container(
            child: Text('目前沒有資料', style: TextStyle(fontSize: ScreenUtil().setSp(MyConstant.textSize_16))),
          ),
        ],
      ),
    );
