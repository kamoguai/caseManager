...
Map<String, dynamic> _$MaintTableCellToJson(MaintTableCell instance) =>
    <String, dynamic>{
      ...
      'CloseDataTime': instance.CloseDataTime,
      'CloseDataTime2': instance.CloseDataTime2,
      'Subject': instance.Subject,
      'CaseTypeName': instance.CaseTypeName,
      'Area': instance.Area,
      'CustNO': instance.CustNO,
      'CustName': instance.CustName,
      'StatusName': instance.StatusName,
      'FUnitName': instance.FUnitName,
      'PDeptName': instance.PDeptName,
      'PUserName': instance.PUserName,
      'PushTime': instance.PushTime,
      'TakeTime': instance.TakeTime,
      'PushTimeDiff': instance.PushTimeDiff,
